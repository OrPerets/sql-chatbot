  ...
  async executeSqlForSubmission(payload: SqlExecutionRequest): Promise<SqlExecutionResponse | null> {
    try {
      ...
      const initializeExamPrepData = () => {
        ...
        `);
        // Scores: some registrations without score yet (Q9). No ScoreID; FirstExamDate = 1 for first sitting.
        alasql(`
          INSERT INTO Scores VALUES
            (1001, 1, 85, '2026-02-16', 1),
            (1001, 2, 90, '2026-02-19', 1),
            (1001, 5, 88, '2026-03-02', 1),
            (1002, 1, 78, '2026-02-16', 1),
            (1002, 7, 81, '2026-03-09', 1),
            (1003, 1, 92, '2026-02-16', 1),
            (1003, 2, 88, '2026-02-19', 1),
            (1003, 3, 95, '2026-02-23', 1),
            (1003, 8, 89, '2026-03-12', 1),
            (1004, 2, 72, '2026-02-19', 1),
            (1004, 10, 84, '2026-03-19', 1),
            (1005, 1, 80, '2026-02-16', 1),
            (1005, 3, 84, '2026-02-23', 1),
            (1005, 9, 86, '2026-03-15', 1),
            (1006, 6, 76, '2026-03-06', 1),
            (1007, 1, 91, '2026-02-16', 1),
            (1007, 2, 87, '2026-02-19', 1),
            (1007, 11, 90, '2026-03-22', 1),
            (1008, 4, 75, '2026-02-26', 1),
            (1008, 7, 79, '2026-03-09', 1),
            (1009, 5, 89, '2026-03-02', 1),
            (1009, 8, 86, '2026-03-12', 1),
            (1009, 12, 91, '2026-03-25', 1),
            (1010, 6, 82, '2026-03-06', 1),
            (1011, 3, 88, '2026-02-23', 1),
            (1011, 5, 90, '2026-03-02', 1),
            (1012, 1, 83, '2026-02-16', 1),
            (1012, 2, 81, '2026-02-19', 1),
            (1012, 9, 85, '2026-03-15', 1),
            (1013, 4, 77, '2026-02-26', 1),
            (1013, 6, 80, '2026-03-06', 1),
            (1014, 8, 74, '2026-03-12', 1),
            (1015, 10, 92, '2026-03-19', 1),
            (1015, 12, 93, '2026-03-25', 1),
            (1016, 11, 87, '2026-03-22', 1);
        `);
      };
