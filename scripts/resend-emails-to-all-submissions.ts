...
// Usage: npx tsx scripts/resend-emails-to-all-submissions.ts <homeworkSetId> [--exclude-student <email>]
async function resendEmailsToAllSubmissions() {
  const args = process.argv.slice(2)
  
  if (args.length === 0) {
    console.log('Usage:')
    console.log('  npx tsx scripts/resend-emails-to-all-submissions.ts <homeworkSetId> [--exclude-student <email>]')
    console.log('\nExample:')
    console.log('  npx tsx scripts/resend-emails-to-all-submissions.ts 693d8a930a7ebe39f7099c88')
    console.log('  npx tsx scripts/resend-emails-to-all-submissions.ts 693d8a930a7ebe39f7099c88 --exclude-student rotemtzubara1@gmail.com')
    process.exit(1)
  }
...
resendEmailsToAllSubmissions().catch(console.error)
