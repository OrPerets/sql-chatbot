...
async function addUsers(): Promise<void> {
  ...
  try {
    ...
    const users: UserDocument[] = [
      ...
      {
        email: 'tamaratshenkar@gmail.com',
        password: 'shenkar',
        firstName: 'תמרה',
        lastName: 'תורן-היבלר',
        isFirst: true,
    ...
    // Check if users already exist by email
...
async function main() {
  try {
    console.log('🚀 Starting process to add users to MongoDB...\n');
    await addUsers();
