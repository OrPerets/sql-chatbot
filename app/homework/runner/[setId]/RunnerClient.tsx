...
const DATABASE_SAMPLE_DATA: Record<string, { columns: string[]; rows: Record<string, string | number>[] }> = {
  ...
  Scores: {
    ...
    rows: [
      { StudentID: 1001, ExamID: 1, Score: 85, GradedAt: "2026-02-16", FirstExamDate: 1 },
      { StudentID: 1001, ExamID: 2, Score: 90, GradedAt: "2026-02-19", FirstExamDate: 1 },
      { StudentID: 1002, ExamID: 1, Score: 78, GradedAt: "2026-02-16", FirstExamDate: 1 },
      { StudentID: 1003, ExamID: 1, Score: 92, GradedAt: "2026-02-16", FirstExamDate: 1 },
      { StudentID: 1003, ExamID: 2, Score: 88, GradedAt: "2026-02-19", FirstExamDate: 1 },
      { StudentID: 1003, ExamID: 3, Score: 95, GradedAt: "2026-02-23", FirstExamDate: 1 },
      { StudentID: 1004, ExamID: 2, Score: 72, GradedAt: "2026-02-19", FirstExamDate: 1 },
      { StudentID: 1005, ExamID: 1, Score: 80, GradedAt: "2026-02-16", FirstExamDate: 1 },
      { StudentID: 1005, ExamID: 3, Score: 84, GradedAt: "2026-02-23", FirstExamDate: 1 },
      { StudentID: 1007, ExamID: 1, Score: 91, GradedAt: "2026-02-16", FirstExamDate: 1 },
      { StudentID: 1007, ExamID: 2, Score: 87, GradedAt: "2026-02-19", FirstExamDate: 1 },
      { StudentID: 1008, ExamID: 4, Score: 75, GradedAt: "2026-02-26", FirstExamDate: 1 },
      { StudentID: 1009, ExamID: 5, Score: 89, GradedAt: "2026-03-02", FirstExamDate: 1 },
      { StudentID: 1009, ExamID: 8, Score: 86, GradedAt: "2026-03-12", FirstExamDate: 1 },
      { StudentID: 1010, ExamID: 6, Score: 82, GradedAt: "2026-03-06", FirstExamDate: 1 },
    ],
  },
};
